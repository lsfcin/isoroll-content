# ROADMAP archive — 2026-H1 strategy tree (SUPERSEDED)
> Moved out of ROADMAP.md 2026-07-09 (P0 consolidation). These strategies predate the NB kit-assembly pivot:
> local SD/ComfyUI generation is now utility-rail only; Blender/TripoSR lanes are fallback (P-Kit) only;
> M6-M8 Foundry runtime items were superseded by the real `isoroll-module` repo.
> Read [SCENE-CREATION.md](../SCENE-CREATION.md) (spec + kill-log) before resurrecting anything here.
