...
Usage:
    python src/pipeline/triposr_mesh.py \\
        --image assets/chars/rogue/concept/rogue_concept_clean.png \\
        --character rogue \\
        [--resolution 128] \\
        [--bake-texture] \\
        [--device cuda:0]
...
Output:
    assets/chars/{character}/mesh/mesh.obj
    assets/chars/{character}/mesh/texture.png  (if --bake-texture)
...
Next step (manual — Mixamo):
    ...
    5. Save FBXs to assets/chars/{character}/rig/{character}_{state}.fbx
...
def main():
    ...
    out_dir = Path(args.output_dir) if args.output_dir else \
              Path(f"assets/chars/{args.character}/mesh")
    ...
    print(f"       assets/chars/{args.character}/rig/{args.character}_idle.fbx")
    print(f"       assets/chars/{args.character}/rig/{args.character}_walk.fbx")
    print(f"       ... etc")
    print()
    print("  7. Render all directions:")
    print(f"       bash src/pipeline/s3_batch.sh {args.character}")
    print("=" * 60)
