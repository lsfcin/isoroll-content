...
Usage:
    ...
    python src/pipeline/rotate_mesh.py assets/chars/rogue/mesh/mesh.obj --angle -90

    # Try +90° if -90 faces wrong direction:
    python src/pipeline/rotate_mesh.py assets/chars/rogue/mesh/mesh.obj --angle 90

    # Try 180° if character faces backward:
    python src/pipeline/rotate_mesh.py assets/chars/rogue/mesh/mesh.obj --angle 180
