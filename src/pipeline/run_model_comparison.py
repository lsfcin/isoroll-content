# run_model_comparison.py — generates one image per checkpoint, saves to benchmarks/model-comparison/
...
RESULTS_DIR = os.path.join(BASE_DIR, "../../benchmarks/model-comparison")
