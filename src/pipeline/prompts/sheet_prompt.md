...
python src/pipeline/sheet_to_tpose.py path/to/sheet.png --character rogue

# Check crops with debug overlay
python src/pipeline/sheet_to_tpose.py path/to/sheet.png --character rogue --debug

# Fine-tune if misaligned
python src/pipeline/sheet_to_tpose.py path/to/sheet.png --character rogue --offset-x 15 --debug

# Feed T-pose front to Zero123 / visual culling pipeline
# assets/chars/rogue/concept/rogue_tpose_front.png → ComfyUI Zero123 workflow → 8 views
