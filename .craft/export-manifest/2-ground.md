...
tasks:
  ...
  T5 — mark export-manifest row done + add pointer to `.craft/export-manifest/` plan in ROADMAP-content-gen.md (Loop 6, on feature branch). — ROADMAP-content-gen.md — low
...
## Ground
branch-created: feature/export-manifest base: feature/scene-creation-consolidation
paths: 6/6 ok | missing: none
test-cmd-runs: yes | output tail: 8 passed, 12 warnings in 0.03s
