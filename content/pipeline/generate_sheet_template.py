...
Usage:
  python content/pipeline/generate_sheet_template.py
  python content/pipeline/generate_sheet_template.py --output path/to/out.png
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", default="content/pipeline/prompts/sheet_template.png")
