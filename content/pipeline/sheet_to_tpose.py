...
Usage:
  python content/pipeline/sheet_to_tpose.py sheet.png --character rogue
  python content/pipeline/sheet_to_tpose.py sheet.png --character rogue --debug
  python content/pipeline/sheet_to_tpose.py sheet.png --character rogue --offset-x 12 --offset-y -8

After cropping, the 3D-ready T-pose (panel [1,0]) is copied to:
  content/chars/{character}/concept/{character}_front_tpose_sheet.png
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Base character directory (default: content/chars/{character})",
    )
    ...
    out_dir = args.output_dir or Path(f"content/chars/{args.character}")
